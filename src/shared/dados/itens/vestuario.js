export const Vestuario = [
  ...
  },
  {
    ...
    preco: "5",
    espacos: 1,
    descricao: "Estas luvas delicadas preservam o tato e impedem que o suor deixe os dedos escorregadios. Fornecem +1 em Ladinggem."
  },
  {
  ...
  },
  {
    ...
    preco: "10",
    espacos: 1,
    descricao: "Inclui botas, calças ou salas, cinto, camisa de linho e capa com capuz. A roupa padrão de aventureiros."
  },
  {
    nome: "Manto camuflado",
    preco: "12",
    espacos: 1,
    descricao: "Este manto é feito para um tipo de terreno específico (veja a página 220). Por exemplo, um manto camuflado para floresta pode ser verde e coberto de folhas, enquanto um manto urbano pode ser cinzento. Usar um manto camuflado no terreno correto fornece +2 em Furtividade."
  },
  {
    nome: "Capa pesada",
    preco: "15",
  ...
  },
  {
    ...
    preco: "50",
    espacos: 1,
    descricao: "Um manto de lã pesado, capaz de proteger contra o frio extremo. Fornece +2 em testes de Fortitude contra efeitos de frio, mas impõe penalidade de armadura de –2."
  },
  {
    nome: "Gorro de ervas",
    preco: "75",
    espacos: 1,
    descricao: "Formado por duas camadas de tecido, este chapéu é preenchido com ervas preparadas para auxiliar a concentração do usuário. Fornece +1 em Vonlade."
  },
  {
    nome: "Traje da corte",
    preco: "100",
