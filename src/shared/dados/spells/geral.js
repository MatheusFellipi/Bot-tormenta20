export const spellsCircle1 = {
  ...
  armaduraArcana: {
    ...
    aprimoramentos: [
      {
        addPm: 1,
        text: "Muda a execução para reação. Em vez do normal, quando sofre um ataque, você cria um escudo mágico que fornece +5 na Defesa contra esse ataque (cumulativo com o bônus do efeito básico desta magia e de armaduras).",
      },
      {
        addPm: 2,
        text: "Aumenta o bônus na Defesa em +1.",
...
export const spellsCircle2 = {
  ...
  enxameDePestes: {
    ...
    aprimoramentos: [
      ...
      {
        addPm: 3,
        text: "Muda a resistência para Reflexos reduz à metade e o enxame para criaturas maiores, como gatos, guaxinins, compsognatos ou kobolds. Ele causa 3d12 pontos de dano (à sua escolha entre corte, impacto ou perfuração). O resto da magia segue normal.",
      },
      {
        addPm: 5,
      ...
      {
        addPm: 7,
        text: "Muda a resistência para Reflexos reduz à metade e o enxame para criaturas elementais. Ele causa 5d12 pontos de dano (à sua escolha entre ácido, eletricidade, fogo ou frio). O resto da magia segue normal. Requer 4º círculo.",
      },
    ],
  },
  sussurosInsanos: {
